...
/**
 * Cities listing page that displays all city blogs in an iframe
...
export default function CitiesPage() {
  ...
  // URL to the external cities listing page
  ...
  useEffect(() => {
    ...
    const handleMessage = (event: MessageEvent) => {
      ...
      // Handle navigation to individual city posts
      if (event.data.type === 'chiri-payload' && event.data.payload?.url) {
        console.log('Navigating to city:', event.data.payload.url)
      ...
      // Handle navigation back to cities listing
      if (event.data.type === 'chiri-cities-button-click') {
        // Already on cities page, no navigation needed
        console.log('Already on cities page')
      }
