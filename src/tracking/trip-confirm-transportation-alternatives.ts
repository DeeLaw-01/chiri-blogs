export const confirmTransportationAlternatives = (transportInfo): void => {
  ...
  window.dataLayer.push({
    event: 'confirmationTransportationAlternatives',
    ...
    trip_stops: transportInfo?.layover_v2?.length - 1,
    transport_company: transportInfo?.carrier,
  })
}
