...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const canonicalUrl = blog.metadata?.canonicalUrl || `https://www.chiri.pk/airlines/${blogSlug}`
...
export default async function AirlinePage({ params }: Props) {
  ...
  const structuredData = generateSchema(blog, `https://chiri.pk/airlines/${blogSlug}`)
