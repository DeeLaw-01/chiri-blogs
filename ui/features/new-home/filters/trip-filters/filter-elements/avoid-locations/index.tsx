...
export default function AvoidLocationsFilter() {
  const { setTripFilters, tripFilters, tripSearch } = useSearchAtoms()
  ...
  return (
    <Select
      ...
      defaultValue={tripFilters?.avoidLocations as LocationResult[]}
      value={tripFilters?.avoidLocations || ([] as LocationResult[])}
      options={locations}
