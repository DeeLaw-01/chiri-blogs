...
import SelectedDatesView from '../selected-dates-view'
...
import StaylengthSelect from '../selected-dates-view/staylength/staylength-select'
...
export default function DatesViewMobile({
  ...
  return (
    <>
      ...
      >
        <StaylengthSelect dates={dates} setDates={setDates} />
        <Divider />
        <SelectedDatesView dates={dates} />
        <ConfirmButton
          searchUpdate={dates}
