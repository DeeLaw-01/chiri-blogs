...
/**
 * Airlines listing page that displays all airline blogs in an iframe
...
export default function AirlinesPage() {
  ...
  // URL to the external airlines listing page
  ...
  useEffect(() => {
    ...
    const handleMessage = (event: MessageEvent) => {
      ...
      // Handle navigation to individual airline posts
      if (event.data.type === 'chiri-payload' && event.data.payload?.url) {
        console.log('Navigating to airline:', event.data.payload.url)
      ...
      // Handle navigation back to airlines listing
      if (event.data.type === 'chiri-airlines-button-click') {
        // Already on airlines page, no navigation needed
        console.log('Already on airlines page')
      }
