...
export default function CountriesBlogPage({ params }: Params) {
  ...
  return (
    <Box
      ...
      src={url}
      style={{ border: 'none' }}
      title={`Countries Blog Post: ${params.slug.join('/')}`}
      loading="lazy"
    />
  )
}
